"""Assemble the Mariachi warm-skeleton variant showcase.

Compositing-only: each source sheet's hero-creature region is cropped with a
per-sheet measured window (the "creature - large" / hero panel), then
fit-inside-scaled so every creature reads whole and undistorted at the same
tile size. The shipped Mariachi anchors the row as a set-apart REFERENCE so a
reviewer can read each new variant against the established silhouette.
"""
...
TILES = [
    {
        "file": "docs/skybit_devil/batch2/mariachi/round_3.png",
        "crop": (35, 100, 275, 258),
        "name": "Mariachi",
        "facet": "strumming charro (shipped)",
        "reference": True,
    },
    {
        "file": "docs/skybit_devil/batch2/mariachi_variants/comelona/round_2.png",
        "crop": (35, 90, 300, 268),
        "name": "Calaca Comelona",
        "facet": "exposed anatomy",
    },
    {
        "file": "docs/skybit_devil/batch2/mariachi_variants/papelito/round_2.png",
        "crop": (35, 80, 290, 282),
        "name": "Papelito",
        "facet": "calaca decoration",
    },
    {
        "file": "docs/skybit_devil/batch2/mariachi_variants/zapateada/round_2.png",
        "crop": (36, 150, 300, 412),
        "name": "Zapateada",
        "facet": "dance / motion",
    },
    {
        "file": "docs/skybit_devil/batch2/mariachi_variants/rison/round_2.png",
        "crop": (40, 130, 270, 400),
        "name": "Rison",
        "facet": "facial character",
    },
    {
        "file": "docs/skybit_devil/batch2/mariachi_variants/charro_jinete/round_3.png",
        "crop": (10, 80, 310, 285),
        "name": "El Charro Jinete",
        "facet": "blend (rider + horse)",
    },
]
...
def main():
    ...
    title = f_title.render("Mariachi warm-skeleton variants", True, TITLE_COL)
