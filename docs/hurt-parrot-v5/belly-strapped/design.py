"""
`belly-strapped` — hurt-parrot V5 concept: shifted jaw pad + lower-flank strap.
...
if __name__ == "__main__":
    ...
    # Summed across the jaw pad and the belly strap: the threshold is about the
