...
title = _font(30, True).render("Skybit — AWARDS star emblem · Round 2 · 5 candidates (AD fixes)",
                               True, _GOLD_BRIGHT)
...
out = "/home/user/skybit/docs/menu_profile_concepts/star_options/round_2.png"
