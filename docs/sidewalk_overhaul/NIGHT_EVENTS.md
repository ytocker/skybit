...
| **N2** | The Stilt-Walker — one tall figure crossing the crowd | 0.730 – 0.744 | t 287.3 s | 6.0 s | `festival_stilts` |
| **N3** | Monkey King's Troupe — the market's second crest | 0.744 – 0.760 | t 292.8 s | 7.0 s | `festival_troupe` |
| **N4** | The Lion — a shorter, self-contained act | 0.762 – 0.774 | t 299.8 s | 6.0 s | `festival_lion` |
| **N5** | The Dragon — the crown; the market pauses for it | 0.788 – 0.818 | t 310.1 s | 10.5 s | `festival_dragon` |
| **N6** | The Dragon Goes Home — carried off, the afterglow | 0.822 – 0.840 | t 323.5 s | 6.0 s | `dragon_home` |
| **N7** | Snowball Fight — small hours, first snow underfoot | 0.845 – 0.905 | t 332.5 s | 4.5 s | `snowball` |
| **N8** | Small Hours — near-empty street, braziers warm | 0.845 – 0.924 | — | — | *(state)* |
...
- **N6 is the only act the market pauses for** — `parade_active()` is keyed to
  ...
  the lion.
- The festival window now opens with ~19.7 s of market before its first
  scheduled act (N2, the stilt-walker, at t 287.3 s): the lantern flood, the
  crest-#1 density peak, the arches and the stalls carry that stretch. The
  Iron Flower used to sit there and was removed — see
  `iron_flower/states.png` for what it was.
