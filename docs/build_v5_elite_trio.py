"""
3-panel comparison: ORIGINAL · bandaged-cheek (V5) · field-dressed (V5).
Output: docs/hurt-parrot-v5-elite-trio.png
"""
...
def main():
    ...
    title = "HURT PARROT · LAST LIFE · ORIGINAL · BANDAGED-CHEEK · FIELD-DRESSED"
    ...
    out_path = os.path.join(REPO, "docs", "hurt-parrot-v5-elite-trio.png")
