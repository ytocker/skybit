"""Round-2 render for tl9 pins2: fish_hook (J return curve + compact eye)"""
import os
...
def _attachment(card, affordable):
    col = (108, 112, 120) if affordable else (78, 82, 92)
    hi  = (165, 170, 178) if affordable else (130, 134, 144)
    kl  = (24, 26, 34)
    # shaft + J-bend with full return curve — tip at (22,18) rises back toward shaft
    pts = [(16, 6), (16, 18), (16, 20), (18, 22), (21, 21), (22, 18)]
    pygame.draw.lines(card, kl, False, pts, 5)
    pygame.draw.lines(card, col, False, pts, 3)
    # highlight on shaft
    pygame.draw.line(card, hi, (15, 7), (15, 17), 1)
    # barb pointing up-inward from hook tip
    pygame.draw.line(card, kl, (22, 18), (20, 19), 3)
    pygame.draw.line(card, col, (22, 18), (20, 19), 2)
    # compact eye: r=3 keyline ring + r=2 metal fill (not a lollipop)
    pygame.draw.circle(card, kl, (16, 5), 3)
    pygame.draw.circle(card, col, (16, 5), 2)
