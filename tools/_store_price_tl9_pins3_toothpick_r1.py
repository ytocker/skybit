"""Round-1 render for tl9 pins3: toothpick (tapered birch stick through tag hole)"""
import os
...
def _attachment(card, affordable):
    wood  = (200, 168, 108) if affordable else (156, 128, 82)
    grain = (168, 136, 80)  if affordable else (126, 100, 58)
    tip   = (218, 192, 148) if affordable else (176, 150, 106)
    kl    = (56,  36,  12)  if affordable else (40,  28,  14)
    # shaft: slight angle gives natural feel (birch stick through tag hole)
    pygame.draw.line(card, kl,    (15, 4),  (14, 24), 4)
    pygame.draw.line(card, wood,  (15, 4),  (14, 24), 2)
    pygame.draw.line(card, grain, (15, 4),  (14, 24), 1)
    # flat cut end at top
    pygame.draw.line(card, tip, (13, 4), (17, 4), 2)
    # tapered point at bottom
    pygame.draw.circle(card, kl,   (14, 24), 2)
    pygame.draw.circle(card, wood, (14, 24), 1)
