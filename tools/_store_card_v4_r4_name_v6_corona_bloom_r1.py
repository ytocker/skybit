...
def _name_corona_bloom(big, name, cx, cy, max_w):
    ...
    x0 = cx - total_w // 2
    band_h = m(20)  # scratch height covers the halo reach
    ...
    RINGS = [
        (m(12), (218, 208, 182), 50),   # champagne outer corona
    ...
    for char, adv in zip(name, advances):
        ...
        # Center the glyph horizontally within its advance slot.
        tile_x = (adv - tw) // 2
        tile_y = (band_h - th) // 2
...
hfont = _font(20, True)
ffont = _font(18, True)
htxt = hfont.render("store_card_v4_r4_name_v6 — corona-bloom — round 1", True, (236, 232, 214))
...
out = "/home/user/skybit/docs/store_card_v4_r4_name_v6/corona-bloom/round_1.png"
