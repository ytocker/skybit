"""Stitch docs/store_card_v4_r4_name_v3/showcase.png — 7-panel comparison figure.
...
Panel layout (left→right):
  ...
  #3 guilloche-sunburst  docs/store_card_v4_r4_name_v3/guilloche-sunburst/round_2.png
  #4 vellum-plaque       docs/store_card_v4_r4_name_v3/vellum-plaque/round_2.png
  #5 footlight-pool      docs/store_card_v4_r4_name_v3/footlight-pool/round_2.png
  #6 backlit-panel       docs/store_card_v4_r4_name_v3/backlit-panel/round_2.png
  #7 cloud-shelf         docs/store_card_v4_r4_name_v3/cloud-shelf/round_2.png
...
PANELS = [
    ...
    ("#3", "guilloche-sunburst","docs/store_card_v4_r4_name_v3/guilloche-sunburst/round_2.png",  342, 36,  324, 200, False),
    ("#4", "vellum-plaque",     "docs/store_card_v4_r4_name_v3/vellum-plaque/round_2.png",       342, 36,  324, 200, False),
    ("#5", "footlight-pool",    "docs/store_card_v4_r4_name_v3/footlight-pool/round_2.png",      342, 36,  324, 200, False),
    ("#6", "backlit-panel",     "docs/store_card_v4_r4_name_v3/backlit-panel/round_2.png",       342, 36,  324, 200, False),
    ("#7", "cloud-shelf",       "docs/store_card_v4_r4_name_v3/cloud-shelf/round_2.png",         342, 36,  324, 200, False),
]
...
hdr_txt = hdr_f.render("Store Card v4  —  Name Treatment v3  (tier-agnostic concepts)", True,
                        (210, 206, 224))
...
out_path = os.path.join(BASE, "docs", "store_card_v4_r4_name_v3", "showcase.png")
