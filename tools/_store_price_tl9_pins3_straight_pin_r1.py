...
def _attachment(card, affordable):
    shaft = (188, 190, 196) if affordable else (148, 150, 156)
    head  = (180, 44, 28)   if affordable else (96, 100, 112)   # red aff, dark steel lock
    hi    = (236, 100, 80)  if affordable else (158, 162, 172)
    kl    = (24, 26, 34)
    # long thin shaft through tag hole, tapered tip at bottom
    pygame.draw.line(card, kl,    (14, 10), (14, 26), 4)
    pygame.draw.line(card, shaft, (14, 10), (14, 26), 2)
    pygame.draw.circle(card, kl, (14, 27), 2)       # needle tip
    # colored ball head at top (r=5 fill, r=6 keyline)
    pygame.draw.circle(card, kl,   (14, 5), 6)
    pygame.draw.circle(card, head, (14, 5), 5)
    pygame.draw.circle(card, hi,   (13, 4), 2)      # specular spot top-left
