"""Stitch the 5 matured run-summary unlock-notice concepts into one labeled
comparison figure: docs/achievements/unlock_notice/showcase.png.

Scratch tooling only; nothing here is imported by the game.

    python tools/build_unlock_notice_showcase.py
"""
import os
...
# (slug, final-round file, one-line thesis) in the order they sit in the figure.
CONCEPTS = [
    ("medal-rail", "round_2.png",
     "Badges on a ribbon sash down the dead left margin."),
    ("plaque-seal", "round_1.png",
     "Wax-seal medallions stamped into the score-plaque corner."),
    ("caption-gap-ticker", "round_1.png",
     "One engraved gold line in the free gap between rows."),
    ("award-interstitial", "round_1.png",
     "Fast, skippable full-screen award beat before the summary."),
    ("corner-rosette", "round_2.png",
     "Foil-seal stamp + 'N EARNED' counter in the top corner."),
]
...
def main():
    ...
    # Deep-night vertical wash to match the in-game backdrops.
    ...
    title = _font(38, True).render(
        "RUN-SUMMARY UNLOCK NOTICE  ·  5 DIRECTIONS", True, _GOLD_BRIGHT)
