"""Round-1 render for tl9 pins3: bobby_pin (hair grip — U-loop + straight/crimped prong pair)"""
import os
...
def _attachment(card, affordable):
    import math
    metal = (162, 166, 174) if affordable else (118, 122, 130)
    hi    = (208, 212, 218) if affordable else (166, 170, 178)
    kl    = (24, 26, 34)
    # U-loop at top connecting both prongs (arc covers top half of bounding rect)
    pygame.draw.arc(card, kl,    pygame.Rect(9, 4, 10, 8), math.radians(0), math.radians(180), 3)
    pygame.draw.arc(card, metal, pygame.Rect(9, 4, 10, 8), math.radians(0), math.radians(180), 2)
    # outer straight prong (left) — smooth, no crimp
    pygame.draw.line(card, kl,    (9,  8), (9,  22), 3)
    pygame.draw.line(card, metal, (9,  8), (9,  22), 2)
    pygame.draw.line(card, hi,    (8,  9), (8,  21), 1)   # edge highlight
    # inner crimped prong (right) — gentle wave for grip texture
    pts = [(19, 8), (18, 12), (19, 16), (18, 20), (19, 22)]
    pygame.draw.lines(card, kl,    False, pts, 3)
    pygame.draw.lines(card, metal, False, pts, 2)
...
fh = hud_font(18)
fl = hud_font(12)
title = fh.render(f"tl9 pins3: {SLUG} — round 1", True, (240, 224, 180))
...
out = f"docs/store_price_tl9_pins3/{SLUG}/round_1.png"
