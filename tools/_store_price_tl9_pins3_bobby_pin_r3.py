"""Round-3 render for tl9 pins3: bobby_pin (hair grip — U-loop + straight/crimped prong pair)"""
import os
...
def _attachment(card, affordable):
    ...
    # outer straight prong — y=10, equalized weight (kl=3, body=2)
    pygame.draw.line(card, kl,   (6, 10), (22, 10), 3)
    pygame.draw.line(card, body, (6, 10), (22, 10), 2)
    pygame.draw.line(card, hi,   (6,  9), (22,  9), 1)   # top-edge shine

    # inner crimped prong — y≈20, ±2px amplitude, 3 clean waves
    # nudged down from y=18 to y=20 to open cream gap between prongs
    pts = [(6, 20), (9, 18), (14, 20), (17, 18), (22, 20)]
    pygame.draw.lines(card, kl,   False, pts, 3)
    pygame.draw.lines(card, body, False, pts, 2)

    # U-bend — connects y=10 to y=20 cleanly (height=10)
    pygame.draw.arc(card, kl,   pygame.Rect(2, 10, 8, 10), math.radians(90), math.radians(270), 3)
    pygame.draw.arc(card, body, pygame.Rect(2, 10, 8, 10), math.radians(90), math.radians(270), 2)
    # specular at U-bend apex (leftmost point of arc at y=15)
    pygame.draw.circle(card, super_hi, (2, 15), 1)
