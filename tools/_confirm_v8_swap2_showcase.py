#!/usr/bin/env python3
"""Assemble swap-round-2 showcase: BEFORE + 4 round_2 concept panels (EPIC tier)."""
...
SWAP_DIR = os.path.join(REPO, "docs", "confirm_purchase_v8", "swap-round-2")
FONT_PATH = os.path.join(REPO, "game", "assets", "LiberationSans-Bold.ttf")

SLUGS = ["sovereign-orbit", "bullion-channel", "swing-ticket", "treasury-arch"]

# Strip layout at 2× output scale (MARGIN=20, HEAD=58, GAP=12, POP=260×442)
_M2 = 40   # MARGIN×2
_H2 = 116  # HEAD×2
_G2 = 24   # GAP×2
