"""Stitch docs/store_card_v4_r4_name_v5/showcase.png — 7-panel comparison figure.
...
Panel layout (left→right):
  ...
  #3 molten-cast         docs/store_card_v4_r4_name_v5/molten-cast/round_2.png
  #4 struck-proof        docs/store_card_v4_r4_name_v5/struck-proof/round_2.png
  #5 backlit-silhouette  docs/store_card_v4_r4_name_v5/backlit-silhouette/round_1.png
  #6 bookend-swash       docs/store_card_v4_r4_name_v5/bookend-swash/round_2.png
  #7 rising-heat         docs/store_card_v4_r4_name_v5/rising-heat/round_2.png
...
PANELS = [
    ...
    ("#3", "molten-cast",        "docs/store_card_v4_r4_name_v5/molten-cast/round_2.png",              342, 36,  324, 200, False),
    ("#4", "struck-proof",       "docs/store_card_v4_r4_name_v5/struck-proof/round_2.png",             342, 36,  324, 200, False),
    ("#5", "backlit-silhouette", "docs/store_card_v4_r4_name_v5/backlit-silhouette/round_1.png",       342, 36,  324, 200, False),
    ("#6", "bookend-swash",      "docs/store_card_v4_r4_name_v5/bookend-swash/round_2.png",            342, 36,  324, 200, False),
    ("#7", "rising-heat",        "docs/store_card_v4_r4_name_v5/rising-heat/round_2.png",              342, 36,  324, 200, False),
]
...
hdr_txt = hdr_f.render("Store Card v4  —  Name Treatment v5  (per-letter light concepts, evolved)", True,
                        (210, 206, 224))
...
out_path = os.path.join(BASE, "docs", "store_card_v4_r4_name_v5", "showcase.png")
