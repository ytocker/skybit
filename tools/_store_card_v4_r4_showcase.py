"""Stitch docs/store_card_v4_r4/showcase.png — 7-panel comparison figure.

Panel layout (left→right):
  #1 ORIGINAL         docs/store_card_v4/original.png
  #2 BASIS (#4 r3)    docs/store_card_v4_r3/neon-marquee/round_2.png
  #3 forge-plate      docs/store_card_v4_r4/forge-plate/round_2.png
  #4 lacquer-panel    docs/store_card_v4_r4/lacquer-panel/round_2.png
  #5 guilloche-strike docs/store_card_v4_r4/guilloche-strike/round_2.png
  #6 woven-carbon     docs/store_card_v4_r4/woven-carbon/round_2.png
  #7 enamel-inlay     docs/store_card_v4_r4/enamel-inlay/round_2.png
...
PANELS = [
    ...
    ("#2", "BASIS (#4 r3)",    "docs/store_card_v4_r3/neon-marquee/round_2.png",     342, 36,  324, 200, False),
    ("#3", "forge-plate",      "docs/store_card_v4_r4/forge-plate/round_2.png",      342, 36,  324, 200, False),
    ("#4", "lacquer-panel",    "docs/store_card_v4_r4/lacquer-panel/round_2.png",    342, 36,  324, 200, False),
    ("#5", "guilloche-strike", "docs/store_card_v4_r4/guilloche-strike/round_2.png", 342, 36,  324, 200, False),
    ("#6", "woven-carbon",     "docs/store_card_v4_r4/woven-carbon/round_2.png",     342, 36,  324, 200, False),
    ("#7", "enamel-inlay",     "docs/store_card_v4_r4/enamel-inlay/round_2.png",     342, 36,  324, 200, False),
]
...
hdr_txt = hdr_f.render("Store Card v4  —  Landscape Evolution  (r4 concepts)", True,
                        (210, 206, 224))
...
out_path = os.path.join(BASE, "docs", "store_card_v4_r4", "showcase.png")
