"""Round-1 render for tl9 pins3: straight_pin (dressmaker pin — colored ball head + shaft)"""
import os
...
def _attachment(card, affordable):
    ...
    # ball head tones — affordable = red, locked = dark steel
    if affordable:
    ...
    # --- shaft (vertical, center x=14) ---
    pygame.draw.line(card, kl,        (14, 11), (14, 27), 4)   # kl
    pygame.draw.line(card, sh_shadow, (13, 11), (13, 27), 1)   # left-edge shadow
    pygame.draw.line(card, sh_mid,    (14, 11), (14, 27), 2)   # main body
    pygame.draw.line(card, sh_hi,     (15, 11), (15, 27), 1)   # right-edge highlight

    # needle tip
    pygame.draw.circle(card, kl,     (14, 28), 2)
    pygame.draw.circle(card, sh_mid, (14, 28), 1)

    # --- ball head (sphere illusion: shadow arc bottom, main fill, gloss top-left) ---
    pygame.draw.circle(card, kl,          (14, 5), 7)           # kl outline
    pygame.draw.circle(card, ball_mid,    (14, 5), 6)           # main fill
    pygame.draw.circle(card, ball_shadow, (14, 7), 4)           # lower shadow arc
    pygame.draw.circle(card, ball_hi,     (12, 3), 3)           # top-left specular
