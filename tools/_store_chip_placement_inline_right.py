"""Concept: inline-right — chip on same horizontal line as the STORE title (y=38)."""
import os
...
def _draw_balance_inline_right(self, surf, y):
    """Chip right-aligned at y=38, sharing the STORE title's horizontal band."""
    cy = 38
    val = f"{sd.balance():,}"
    vf = _font(18, True)
...
st.StoreScene._draw_balance = _draw_balance_inline_right
...
out = "/home/user/skybit/docs/store_coin_chip_placement/inline-right.png"
