"""Round-2 render for tl9 pins3: push_pin (thumbtack — large disc head + shaft)"""
import os
...
def _attachment(card, affordable):
    if affordable:
        disc_shadow = (140,  28,  18)   # bottom shadow zone — dark red
        disc_mid    = (190,  50,  32)   # main body fill
        disc_hi     = (240, 140, 120)   # top-left gloss (large — plastic not metal)
    else:
        disc_shadow = ( 66,  68,  82)
        disc_mid    = (102, 106, 118)
        disc_hi     = (176, 180, 190)
    ...
    # --- shaft (below disc, vertical) ---
    pygame.draw.line(card, kl,        (14, 15), (14, 26), 4)
    pygame.draw.line(card, sh_shadow, (13, 15), (13, 26), 1)   # left-edge shadow
    pygame.draw.line(card, sh_mid,    (14, 15), (14, 26), 2)   # main
    pygame.draw.line(card, sh_hi,     (15, 15), (15, 26), 1)   # right-edge highlight

    # needle tip
    pygame.draw.circle(card, kl,     (14, 27), 2)
    pygame.draw.circle(card, sh_mid, (14, 27), 1)

    # --- disc (flat circular head, center at (14, 7)) ---
    pygame.draw.circle(card, kl,          (14, 7), 9)    # kl outline
    pygame.draw.circle(card, disc_mid,    (14, 7), 8)    # main fill
    pygame.draw.circle(card, disc_shadow, (14, 9), 5)    # lower shadow zone
    pygame.draw.circle(card, disc_hi,     (11, 4), 4)    # large top-left gloss (plastic read)
