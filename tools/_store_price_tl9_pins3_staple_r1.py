"""Round-1 render for tl9 pins3: staple (⊓-shape bridge + crimped tips)"""
import os
...
def _attachment(card, affordable):
    metal = (178, 180, 188) if affordable else (130, 132, 138)
    hi    = (218, 220, 226) if affordable else (172, 174, 180)
    kl    = (24, 26, 34)
    # flat bridge bar across top (⊓ shape, not an arch)
    pygame.draw.line(card, kl,    (7, 8),  (21, 8),  4)
    pygame.draw.line(card, metal, (7, 8),  (21, 8),  2)
    pygame.draw.line(card, hi,    (7, 8),  (21, 8),  1)
    # left prong going straight down
    pygame.draw.line(card, kl,    (7, 8),  (7, 20),  4)
    pygame.draw.line(card, metal, (7, 8),  (7, 20),  2)
    # right prong going straight down
    pygame.draw.line(card, kl,    (21, 8), (21, 20), 4)
    pygame.draw.line(card, metal, (21, 8), (21, 20), 2)
    # crimped tips bent inward (as a real staple looks after firing)
    pygame.draw.line(card, kl,    (7,  20), (12, 22), 3)
    pygame.draw.line(card, metal, (7,  20), (12, 22), 2)
    pygame.draw.line(card, kl,    (21, 20), (16, 22), 3)
    pygame.draw.line(card, metal, (21, 20), (16, 22), 2)
