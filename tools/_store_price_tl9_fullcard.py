"""Fullcard comparison: BEFORE (tl8 brushwork r2) vs 5 tl9 brushwork-digit r2 renders.

Crops the affordable mummy card from each round_2.png sheet and arranges them
in a single numbered column at 2× zoom so the digit treatment reads clearly at
review size.
"""
import os
...
CONCEPTS = [
    ("BEFORE",        "docs/store_price_tl8/brushwork/round_2.png"),
    ("1  axis_crush", "docs/store_price_tl9/axis_crush/round_2.png"),
    ("2  nib_shear",  "docs/store_price_tl9/nib_shear/round_2.png"),
    ("3  stroke_rects", "docs/store_price_tl9/stroke_rects/round_2.png"),
    ("4  double_skin","docs/store_price_tl9/double_skin/round_2.png"),
    ("5  size_dance", "docs/store_price_tl9/size_dance/round_2.png"),
]
...
fh = hud_font(20)
fl = hud_font(13)
title = fh.render("tl9 brushwork digit — round 2 comparison (affordable, mummy)", True, (240, 224, 180))
...
out = "docs/store_price_tl9/full_card_comparison.png"
