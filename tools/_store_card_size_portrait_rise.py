...
title = fh.render("portrait-rise  ·  baseline vs concept  (skin_mummy)", True, (240,224,180))
sheet.blit(title, (sheet_w//2 - title.get_width()//2, (HEADER_H - title.get_height())//2))

panels_ss = [("BASELINE (2×)", baseline_ss), ("PORTRAIT-RISE (2×)", concept_ss)]
y_ss = PAD + HEADER_H
...
import os as _os
out = "docs/store_card_size/portrait_rise/round_1.png"
