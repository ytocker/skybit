"""Round-2 render for tl9 pins2: zip_tie (centered loop, cool slot, no strap highlight)"""
import os
...
def _attachment(card, affordable):
    head_col = (34, 36, 42)
    ridge    = (56, 58, 68)
    strap    = (74, 76, 84) if affordable else (62, 64, 74)
    slot_col = (44, 46, 54)
    # grommet hole in tag (dark ring)
    pygame.draw.circle(card, (28, 26, 22), (14, 8), 3)
    pygame.draw.circle(card, (62, 58, 52), (14, 8), 2)
    # ratchet head centered at x=14
    pygame.draw.rect(card, head_col, (9, 10, 10, 6))
    pygame.draw.line(card, ridge, (9, 10), (19, 10), 1)
    # ratchet slot (cool tone, not warm brown)
    pygame.draw.rect(card, slot_col, (12, 12, 5, 3))
    # strap loop centered under head: down from (14,16), right to (20,22), back up to (20,16)
    pygame.draw.line(card, strap, (14, 16), (14, 22), 2)
    pygame.draw.line(card, strap, (14, 22), (20, 22), 2)
    pygame.draw.line(card, strap, (20, 22), (20, 16), 2)
