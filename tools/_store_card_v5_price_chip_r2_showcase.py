"""Showcase figure: BEFORE vs 5 price-chip concepts, iteration 2 (round 2).
...
Output: docs/store_card_v5_price_chip_r2/showcase.png
"""
import os, sys
...
CONCEPTS = [
    ("Ember\nCrown",    "ember-crown",    136, 64),
    ("Gem\nRing",       "gem-ring",        82, 86),
    ("Bold\nCipher",    "bold-cipher",     20, 64),
    ("Aurora\nLip",     "aurora-lip",      20, 44),
    ("Carved\nPlate",   "carved-plate",   124, 64),
]
...
hf   = hud_font(18, True)
htxt = hf.render(
    f"v5 price chip redesign — iteration 2 — BEFORE vs 5 concepts — round 2 ({SID})",
    True, (210, 206, 224))
