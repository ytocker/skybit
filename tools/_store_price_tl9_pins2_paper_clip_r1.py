"""Round-1 render for tl9 pins2: paper_clip"""
import os
...
def _attachment(card, affordable):
    ...
    kl = (24, 26, 34)
    outer = pygame.Rect(4, 10, 18, 9)
    inner = pygame.Rect(10, 11, 12, 6)
    pygame.draw.ellipse(card, kl, outer.inflate(2, 2), 2)
    pygame.draw.ellipse(card, metal, outer, 2)
    pygame.draw.ellipse(card, metal, inner, 2)
