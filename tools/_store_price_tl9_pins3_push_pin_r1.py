"""Round-1 render for tl9 pins3: push_pin (thumbtack — large disc head + shaft)"""
import os
...
def _attachment(card, affordable):
    disc    = (178, 44, 26)   if affordable else (96, 100, 112)   # red aff, dark steel lock
    disc_hi = (230, 90, 70)   if affordable else (152, 156, 166)
    shaft   = (186, 188, 194) if affordable else (144, 146, 152)
    kl      = (24, 26, 34)
    # shaft + needle tip below disc
    pygame.draw.line(card, kl,    (14, 14), (14, 24), 4)
    pygame.draw.line(card, shaft, (14, 14), (14, 24), 2)
    pygame.draw.circle(card, kl, (14, 25), 2)      # needle tip
    # flat disc head (r=7 fill, r=8 keyline) — bold, recognisable thumbtack silhouette
    pygame.draw.circle(card, kl,      (14, 7), 8)
    pygame.draw.circle(card, disc,    (14, 7), 7)
    pygame.draw.circle(card, disc_hi, (12, 5), 3)  # specular highlight top-left
