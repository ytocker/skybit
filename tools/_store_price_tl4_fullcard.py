"""Full-card comparison: BEFORE + 5 tl4 hang-tag concepts (affordable & locked).
...
CONCEPTS = [
    ...
    ("brass-classic",           "tools/_store_price_tl4_brass_classic_r2.py"),
    ("dark-boutique",           "tools/_store_price_tl4_dark_boutique_r2.py"),
    ("kraft-twine",             "tools/_store_price_tl4_kraft_twine_r2.py"),
    ("steel-precision",         "tools/_store_price_tl4_steel_precision_r2.py"),
    ("ledger-ivory",            "tools/_store_price_tl4_ledger_ivory_r2.py"),
]
...
# main header
ht = hf.render("store price · tl4 hang-tag · full-card comparison", True, GOLD)
...
out = "docs/store_price_tl4/full_card_comparison.png"
