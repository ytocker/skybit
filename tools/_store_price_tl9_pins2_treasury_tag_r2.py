"""Round-2 render for tl9 pins2: treasury_tag (darkened bar fill for cream visibility)"""
import os
...
def _attachment(card, affordable):
    bar_outline = (100, 68, 28) if affordable else (58, 62, 74)
    # darkened from r1 (206,180,120) which was invisible over cream — CR was 1.89
    bar_fill    = (158, 112, 48) if affordable else (110, 114, 126)
    string      = (120, 90, 44) if affordable else (104, 108, 120)
    # string connecting bars
    pygame.draw.line(card, string, (18, 12), (18, 21), 2)
    # top crossbar: 5px tall outer, 3px fill
    pygame.draw.rect(card, bar_outline, (13, 7, 10, 5))
    pygame.draw.rect(card, bar_fill, (14, 8, 8, 3))
    # bottom crossbar: 5px tall outer, 3px fill
    pygame.draw.rect(card, bar_outline, (13, 21, 10, 5))
    pygame.draw.rect(card, bar_fill, (14, 22, 8, 3))
