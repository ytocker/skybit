"""Round-1 render sheet for the improved-octagon gem badge concept.
...
def my_facet_gem(surf, cx, cy, r, base, deep, mystery=False):
    ...
    # Warm reflected tint: a low-sun amber bounce, not just a pale wash, so
    # cool shadow facets pick up a believable return instead of dead purple.
    ...
    # no centred/circular pip — plus a distinct hot pip above it, both additive
    # so they read as glass ──
...
def main():
    ...
    header = hf.render("gem badge — improved-octagon r1", True, (236, 232, 250))
