"""store_card_v3_tl showcase stitch.

Extracts the EPIC-tier panel (2× SS, 324×200) from each concept's round_2.png
review sheet (second column, index 1), plus the pre-rendered original, and
stitches them into a 6-panel showcase. A real-scale 1× strip (162×100) is
appended below each panel.
"""
import os
...
CONCEPTS = [
    ("CURRENT",        "docs/store_card_v3_tl/original.png",                    None),
    ("portrait-plate", "docs/store_card_v3_tl/portrait-plate/round_2.png",      EPIC_CROP),
    ("sidebar-codex",  "docs/store_card_v3_tl/sidebar-codex/round_2.png",       EPIC_CROP),
    ("poster-backdrop","docs/store_card_v3_tl/poster-backdrop/round_2.png",      EPIC_CROP),
    ("crown-peek",     "docs/store_card_v3_tl/crown-peek/round_2.png",           EPIC_CROP),
    ("locket-medallion","docs/store_card_v3_tl/locket-medallion/round_2.png",   EPIC_CROP),
]
...
htxt = hfont.render("store_card_v3_tl — showcase (EPIC tier, gem TL / price TR / name bottom)", True, (236, 232, 214))
...
out = "docs/store_card_v3_tl/showcase.png"
