"""6-row sky showcase v3: ORIGINAL + 5 natural-gradient variants (vA–vE).

Output: docs/sky_transition/showcase_v3.png

    python tools/render_sky_showcase_v3.py
"""
import os
import sys
...
CONCEPTS = [
    ("ORIGINAL",           None),
    ("vA  Rose Settle",    "vA_rose_settle/round_2.png"),
    ("vB  Plum Deepen",    "vB_plum_deepen/round_2.png"),
    ("vC  Velvet Haze",    "vC_velvet_haze/round_2.png"),
    ("vD  Ember Fade",     "vD_ember_fade/round_2.png"),
    ("vE  Magenta Mist",   "vE_magenta_mist/round_2.png"),
]
...
def main():
    ...
    mt = f_main.render(
        "Alpine Haze — Natural Gradient Fix: 5 Options  (Phases 0.42 / 0.47 / 0.52)",
        True, TEXT_HI)
    ...
    out = os.path.join(_ROOT, "docs", "sky_transition", "showcase_v3.png")
    ...
    for i, (name, _) in enumerate(CONCEPTS):
        ...
        print(f"  {name:22s} panel4 mid: {px}")
