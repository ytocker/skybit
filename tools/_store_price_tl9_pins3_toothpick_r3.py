"""Round-3 render for tl9 pins3: toothpick (tapered birch stick through tag hole)"""
import os
...
def _attachment(card, affordable):
    if affordable:
        shadow = (176, 150, 110)   # warm tan shadow side
        mid    = (214, 190, 148)   # warm birch — clearly visible on tag
        grain  = (188, 162, 118)   # grain dashes — DARKER than mid
        endcap = (224, 202, 158)   # flat-cut end
        kl     = (52,  32,  10)    # dark brown
    else:
        shadow = (148, 126,  90)
        mid    = (180, 158, 118)
        grain  = (156, 132,  96)
    ...
    # shaft — diagonal lean, 4px kl for a stick feel
    pygame.draw.line(card, kl,     (16,  5), (13, 23), 4)   # kl outline
    pygame.draw.line(card, shadow, (15,  5), (12, 23), 1)   # shadow-side left edge
    pygame.draw.line(card, mid,    (16,  5), (13, 23), 2)   # main warm body

    # grain — DARKER dashes along center, broken (2–3 ticks)
    pygame.draw.line(card, grain, (15,  8), (14, 11), 1)   # dash 1
    pygame.draw.line(card, grain, (15, 14), (14, 17), 1)   # dash 2
    pygame.draw.line(card, grain, (14, 20), (13, 22), 1)   # dash 3

    # flat-cut end at top
    pygame.draw.line(card, kl,     (13,  5), (18,  5), 2)
    pygame.draw.line(card, endcap, (14,  5), (17,  5), 1)

    # tapered point at bottom — converging lines to a 1px tip, NOT a circle
    pygame.draw.line(card, kl,  (14, 22), (13, 26), 2)   # left taper edge
    pygame.draw.line(card, kl,  (15, 22), (13, 26), 2)   # right taper to same point
    pygame.draw.line(card, mid, (14, 22), (13, 25), 1)   # warm fill narrows to tip
