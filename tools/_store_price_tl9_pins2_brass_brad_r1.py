"""Round-1 render for tl9 pins2: brass_brad"""
import os
...
def _attachment(card, affordable):
    brass = (182, 142, 46) if affordable else (140, 145, 158)
    hi = (214, 180, 96) if affordable else (180, 185, 195)
    kl = (70, 50, 16) if affordable else (30, 32, 40)
    tip = (150, 116, 40) if affordable else (115, 120, 132)
    # splayed prongs
    pygame.draw.line(card, brass, (16, 17), (10, 23), 2)
    pygame.draw.line(card, brass, (16, 17), (22, 23), 2)
    pygame.draw.rect(card, tip, (9, 22, 2, 2))
    pygame.draw.rect(card, tip, (21, 22, 2, 2))
    # domed head
    pygame.draw.circle(card, kl, (16, 12), 6)
    pygame.draw.circle(card, brass, (16, 12), 5)
    arc_rect = pygame.Rect(11, 7, 10, 10)
    pygame.draw.arc(card, hi, arc_rect, math.radians(90), math.radians(180), 1)
