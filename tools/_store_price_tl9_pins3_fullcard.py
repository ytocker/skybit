"""Full-card comparison: 5 pins3 r1 concepts at 2×"""
import os
...
title = fh.render("tl9 pins3 — round 1 (affordable, mummy, 2×)", True, (240, 224, 180))
...
for i, slug in enumerate(SLUGS):
    r1_path = f"docs/store_price_tl9_pins3/{slug}/round_1.png"
    r1_sheet = pygame.image.load(r1_path).convert_alpha()
    # mummy-aff card at (PAD=20, PAD+HEADER_H=60) in sheet, size 162×100
    crop = r1_sheet.subsurface(pygame.Rect(20, 60, 162, 100))
...
out = "docs/store_price_tl9_pins3/full_card_comparison.png"
