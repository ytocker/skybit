"""Round-3 render for tl9 pins3: push_pin (thumbtack — large disc head + shaft)"""
import os
...
def _attachment(card, affordable):
    if affordable:
        disc_shadow = (140,  28,  18)
        disc_mid    = (190,  50,  32)
        disc_glow   = (215,  95,  76)    # mid-step gloss ring (new — between mid and hi)
        disc_hi     = (248, 148, 128)    # bright salmon tip gloss
    else:
        # distinctly blue-grey disc so it reads as a different material from the silver shaft
        disc_shadow = ( 52,  56,  94)    # dark blue-grey shadow
        disc_mid    = ( 88,  92, 140)    # blue-grey main
        disc_glow   = (130, 134, 178)    # mid gloss ring
        disc_hi     = (188, 192, 220)    # light blue-grey gloss
    sh_shadow = (148, 150, 158)
    sh_mid    = (192, 194, 200)
    sh_hi     = (220, 222, 226)
    kl        = (24, 26, 34)

    # shaft — 3-tone (unchanged from r2 except tip fix)
    pygame.draw.line(card, kl,        (14, 16), (14, 26), 4)
    pygame.draw.line(card, sh_shadow, (13, 16), (13, 26), 1)
    pygame.draw.line(card, sh_mid,    (14, 16), (14, 26), 2)
    pygame.draw.line(card, sh_hi,     (15, 16), (15, 26), 1)

    # needle tip — taper to point
    pygame.draw.line(card, kl,     (13, 25), (14, 28), 2)
    pygame.draw.line(card, kl,     (15, 25), (14, 28), 2)
    pygame.draw.line(card, sh_mid, (14, 25), (14, 27), 1)

    # disc — 3-zone dome (shadow at BOTTOM-RIGHT, not center)
    pygame.draw.circle(card, kl,          (14, 7),  9)    # kl outline
    pygame.draw.circle(card, disc_mid,    (14, 7),  8)    # main fill
    pygame.draw.circle(card, disc_shadow, (16, 11), 5)    # BOTTOM-RIGHT shadow (not center!)
    pygame.draw.circle(card, disc_glow,   (12, 4),  5)    # mid gloss ring (stepped)
    pygame.draw.circle(card, disc_hi,     (11, 3),  3)    # bright gloss peak
