"""Round-1 render for tl9 pins2: split_ring"""
import os
...
def _attachment(card, affordable):
    col = (112, 116, 124) if affordable else (80, 84, 94)
    kl = (24, 26, 34)
    # double-coil split ring: two offset circles
    c1, c2 = (13, 15), (17, 15)
    pygame.draw.circle(card, kl, c1, 7, 2)
    pygame.draw.circle(card, kl, c2, 7, 2)
    pygame.draw.circle(card, col, c1, 6, 2)
    pygame.draw.circle(card, col, c2, 6, 2)
