"""Round-1 render for tl9 pins2: toggle_clasp"""
import os
...
def _attachment(card, affordable):
    col = (170, 130, 42) if affordable else (150, 154, 166)
    kl = (70, 50, 16) if affordable else (30, 32, 40)
    # T-bar stem + crossbar
    pygame.draw.rect(card, kl, (8, 9, 14, 5))
    pygame.draw.rect(card, col, (9, 10, 12, 3))
    pygame.draw.rect(card, kl, (13, 5, 5, 6))
    pygame.draw.rect(card, col, (14, 6, 3, 5))
    # O-ring below
    pygame.draw.circle(card, kl, (15, 21), 7, 2)
    pygame.draw.circle(card, col, (15, 21), 6, 3)
    arc_rect = pygame.Rect(9, 15, 12, 12)
    pygame.draw.arc(card, kl, arc_rect.inflate(2, 2), math.radians(0), math.radians(180), 2)
    pygame.draw.arc(card, col, arc_rect, math.radians(0), math.radians(180), 3)
