"""Stitch docs/store_card_v4_r4_name_v2/showcase.png — 7-panel comparison figure.
...
Panel layout (left→right):
  ...
  #3 etched-cartouche  docs/store_card_v4_r4_name_v2/etched-cartouche/round_2.png
  #4 steel-nameplate   docs/store_card_v4_r4_name_v2/steel-nameplate/round_2.png
  #5 marquee-glow      docs/store_card_v4_r4_name_v2/marquee-glow/round_2.png
  #6 arcade-cap        docs/store_card_v4_r4_name_v2/arcade-cap/round_2.png
  #7 shelf-deboss      docs/store_card_v4_r4_name_v2/shelf-deboss/round_2.png
...
PANELS = [
    ...
    ("#3", "etched-cartouche","docs/store_card_v4_r4_name_v2/etched-cartouche/round_2.png",   342, 36,  324, 200, False),
    ("#4", "steel-nameplate", "docs/store_card_v4_r4_name_v2/steel-nameplate/round_2.png",    342, 36,  324, 200, False),
    ("#5", "marquee-glow",    "docs/store_card_v4_r4_name_v2/marquee-glow/round_2.png",       342, 36,  324, 200, False),
    ("#6", "arcade-cap",      "docs/store_card_v4_r4_name_v2/arcade-cap/round_2.png",         342, 36,  324, 200, False),
    ("#7", "shelf-deboss",    "docs/store_card_v4_r4_name_v2/shelf-deboss/round_2.png",       342, 36,  324, 200, False),
]
...
hdr_txt = hdr_f.render("Store Card v4  —  Name Treatment v2  (tier-agnostic concepts)", True,
                        (210, 206, 224))
...
out_path = os.path.join(BASE, "docs", "store_card_v4_r4_name_v2", "showcase.png")
