"""Phase-5 showcase for the gem-badge /design run.

Six panels (BEFORE + 5 concepts), single row:
  BEFORE — original facet_gem unchanged
  radiant-brilliant / rose-cut / star-gem / halo-orb / shield-cut — each
  cropped from the concept's round_2.png at the mummy-EPIC card position.
"""
import os
import sys
...
# round_2 layout constants (same across all 5 concept scripts)
R2_PAD     = 28
R2_GAP     = 24
R2_HDR_H   = 34   # hud_font(30, True).render height
...
def _crop_mummy(slug):
    """Load round_2.png for a concept and crop the skin_mummy card from it."""
    path = f"/home/user/skybit/docs/store_card_v5_gem_badge/{slug}/round_2.png"
...
def main():
    ...
    hdr = hdr_f.render("gem badge redesign — v5 store card showcase", True, (232, 228, 246))
    ...
    out = "/home/user/skybit/docs/store_card_v5_gem_badge/showcase.png"
