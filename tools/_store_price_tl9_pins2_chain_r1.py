"""Round-1 render for tl9 pins2: chain"""
import os
...
def _attachment(card, affordable):
    ...
    link1 = pygame.Rect(8, 6, 10, 6)
    link2 = pygame.Rect(10, 11, 10, 6)
    ...
    pygame.draw.circle(card, kl, (13, 5), 3)
    pygame.draw.circle(card, link, (13, 5), 2)
