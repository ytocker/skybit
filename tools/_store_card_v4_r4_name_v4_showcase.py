"""Stitch docs/store_card_v4_r4_name_v4/showcase.png — 7-panel comparison figure.
...
Panel layout (left→right):
  ...
  #3 letter-lantern      docs/store_card_v4_r4_name_v4/letter-lantern/round_2.png
  #4 filament-core       docs/store_card_v4_r4_name_v4/filament-core/round_2.png
  #5 capsule-key         docs/store_card_v4_r4_name_v4/capsule-key/round_2.png
  #6 facet-seat          docs/store_card_v4_r4_name_v4/facet-seat/round_2.png
  #7 engraved-strike     docs/store_card_v4_r4_name_v4/engraved-strike/round_2.png
...
PANELS = [
    ...
    ("#3", "letter-lantern",   "docs/store_card_v4_r4_name_v4/letter-lantern/round_2.png",       342, 36,  324, 200, False),
    ("#4", "filament-core",    "docs/store_card_v4_r4_name_v4/filament-core/round_2.png",        342, 36,  324, 200, False),
    ("#5", "capsule-key",      "docs/store_card_v4_r4_name_v4/capsule-key/round_2.png",          342, 36,  324, 200, False),
    ("#6", "facet-seat",       "docs/store_card_v4_r4_name_v4/facet-seat/round_2.png",           342, 36,  324, 200, False),
    ("#7", "engraved-strike",  "docs/store_card_v4_r4_name_v4/engraved-strike/round_2.png",      342, 36,  324, 200, False),
]
...
hdr_txt = hdr_f.render("Store Card v4  —  Name Treatment v4  (per-letter light concepts)", True,
                        (210, 206, 224))
...
out_path = os.path.join(BASE, "docs", "store_card_v4_r4_name_v4", "showcase.png")
