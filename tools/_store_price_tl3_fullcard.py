"""Full-card comparison: BEFORE + 5 tl3 hang-tag concepts (affordable & locked).
...
CONCEPTS = [
    ("BEFORE\n(original)",   None),
    ("arch-black",           "tools/_store_price_tl3_arch_black_r2.py"),
    ("chain-steel",          "tools/_store_price_tl3_chain_steel_r2.py"),
    ("double-tag",           "tools/_store_price_tl3_double_tag_r2.py"),
    ("pennant-pewter",       "tools/_store_price_tl3_pennant_pewter_r2.py"),
    ("wax-cream",            "tools/_store_price_tl3_wax_cream_r2.py"),
]
...
# main header
ht = hf.render("store price · tl3 hang-tag · full-card comparison", True, GOLD)
...
out = "docs/store_price_tl3/full_card_comparison.png"
