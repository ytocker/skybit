"""Round-1 render for the `brass-classic` tl4 store-card price tag.
...
def _draw_price(face, text, center, col_key, col_fill_stops=None, col_fill_flat=None, fs=13):
    """Pour the price into a faux-bold glyph mask wrapped in an 8-point keyline
    so the engraved numerals stay crisp against the cartouche in either state."""
...
def my_price_chip(surf, cx, cy, text, h, variant=sc.PRICE_VARIANT, **kw):
    ...
    if affordable:
        ...
        _draw_price(face, text, (FACE_W // 2, 58), (48, 52, 66),
                    col_fill_flat=(200, 206, 220), fs=13)
...
fh = hud_font(22)
fl = hud_font(13)
sheet.blit(fh.render("BRASS-CLASSIC — tl4 hang-tag round 1", True, (240, 224, 180)),
           (PAD, PAD // 2))
...
out = "docs/store_price_tl4/brass_classic/round_1.png"
