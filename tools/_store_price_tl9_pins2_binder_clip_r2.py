"""Round-2 render for tl9 pins2: binder_clip (outward-splay handles)"""
import os
...
def _attachment(card, affordable):
    jaw = (30, 32, 38) if affordable else (26, 28, 34)
    hdl = (100, 104, 114) if affordable else (70, 74, 84)
    hi  = (180, 184, 192) if affordable else (150, 154, 162)
    kl  = (24, 26, 34)
    pygame.draw.rect(card, jaw, (10, 12, 14, 4))
    # handles splay OUTWARD: apices farther from center than bases, clear V gap between them
    pygame.draw.polygon(card, hdl, [(10, 12), (14, 12), (7, 5)])   # left wing, apex at x=7
    pygame.draw.polygon(card, hdl, [(20, 12), (24, 12), (25, 5)])  # right wing, apex at x=25
    # highlights on outer edges (rim light on each wing)
    pygame.draw.line(card, hi, (10, 12), (7, 5), 1)
    pygame.draw.line(card, hi, (24, 12), (25, 5), 1)
    # keylines on inner edges for silhouette definition
    pygame.draw.line(card, kl, (14, 12), (7, 5), 1)
    pygame.draw.line(card, kl, (20, 12), (25, 5), 1)
