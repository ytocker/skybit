...
def _name_temper_gradient(big, name, cx, cy, max_w):
    ...
    # DISCRETE TEMPERATURE STOPS: outer→inner. All normal-alpha.
    # AD: CARD_RING_BRIGHT is a hard outer stop, NOT a wash. Leave a micro-gap
    # between champagne and gold so the temperature step reads intentional.
    RINGS = [
        (m(6), (236, 202, 116), 70),   # CARD_RING_BRIGHT warm-gold outer stop
        (m(4), (218, 208, 182), 120),  # champagne
        (m(2), (250, 244, 225), 170),  # ivory
...
hfont = _font(20, True)
ffont = _font(18, True)
htxt = hfont.render("store_card_v4_r4_name_v6 — temper-gradient — round 1", True, (236, 232, 214))
...
out = "/home/user/skybit/docs/store_card_v4_r4_name_v6/temper-gradient/round_1.png"
