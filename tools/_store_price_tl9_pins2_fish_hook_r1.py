"""Round-1 render for tl9 pins2: fish_hook"""
import os
...
def _attachment(card, affordable):
    ...
    kl  = (24, 26, 34)
    pygame.draw.line(card, kl, (16, 5), (16, 18), 5)
    pygame.draw.lines(card, kl, False, [(16, 18), (17, 20), (19, 22), (21, 22)], 5)
    pygame.draw.line(card, col, (16, 5), (16, 18), 3)
    pygame.draw.lines(card, col, False, [(16, 18), (17, 20), (19, 22), (21, 22)], 3)
    pygame.draw.line(card, hi, (15, 6), (15, 17), 1)
    pygame.draw.line(card, col, (21, 22), (18, 19), 2)
    pygame.draw.circle(card, kl, (16, 5), 4)
    pygame.draw.circle(card, col, (16, 5), 3)
