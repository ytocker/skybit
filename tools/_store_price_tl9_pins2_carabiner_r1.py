"""Round-1 render for tl9 pins2: carabiner"""
import os
...
def _attachment(card, affordable):
    ...
    ring_rect = pygame.Rect(11, 7, 9, 15)
    pygame.draw.rect(card, kl, ring_rect.inflate(2, 2), 2, border_radius=4)
    pygame.draw.rect(card, col, ring_rect, 2, border_radius=3)
    # gate bar (spine side)
    pygame.draw.line(card, col, (17, 10), (17, 19), 2)
    # highlight on spine
    pygame.draw.line(card, hi, (12, 8), (12, 21), 1)
