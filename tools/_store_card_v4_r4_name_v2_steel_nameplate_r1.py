...
def _name_steel_nameplate(big, name, cx, cy, max_w):
    ...
    # Champagne-pewter vertical ramp — cool silver crown, warm pewter mid, deep
    # graphite foot. Kept deliberately OFF amber/gold at every stop so the plate
    # never drifts into a second gold surface next to the frame.
    plate = vgrad_stops(mw, mh, 0,
                        [(0.0, (216, 208, 192)),
                         (0.45, (178, 170, 152)),
                         (1.0, (120, 114, 98))], 255, gamma=1.05)
    ...
    # Raised emboss — warm key light TOP-LEFT, warm undercut BOTTOM-RIGHT, to
    # match the card's bevel_rim light source. Highlight laid first, shadow next,
    # ramp-filled face last so the metal owns the centre.
    hi = mask.copy()
    hi.fill((250, 246, 236, 255), special_flags=pygame.BLEND_RGBA_MULT)
...
htxt = hfont.render("store_card_v4_r4_name_v2 — steel-nameplate — round 1", True, (236, 232, 214))
...
out = "/home/user/skybit/docs/store_card_v4_r4_name_v2/steel-nameplate/round_1.png"
