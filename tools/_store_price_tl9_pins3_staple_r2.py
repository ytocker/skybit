"""Round-2 render for tl9 pins3: staple (⊓-shape bridge + crimped tips)"""
import os
...
def _attachment(card, affordable):
    import math
    if affordable:
        shadow = (108, 124, 134)   # zinc shadow — cool blue-grey
        mid    = (168, 189, 198)   # zinc mid
        hi     = (214, 226, 230)   # zinc highlight
    else:
        shadow = (88,  90,  96)
        mid    = (130, 132, 138)
        hi     = (180, 182, 188)
    ...
    # --- crown (top bar of ⊓) — bright top edge, mid face, shadow underside ---
    pygame.draw.line(card, kl,     (6,  6), (22,  6), 5)   # kl outline
    pygame.draw.line(card, hi,     (6,  6), (22,  6), 1)   # top-edge catch-light
    pygame.draw.line(card, mid,    (6,  7), (22,  7), 3)   # main face
    pygame.draw.line(card, shadow, (6,  9), (22,  9), 1)   # underside shadow

    # --- left leg ---
    pygame.draw.line(card, kl,    (7,  8), (7,  21), 4)    # kl
    pygame.draw.line(card, mid,   (7,  8), (7,  21), 2)    # outer face
    ...
    # --- crimped tips bent inward (open bottom — NOT a closed rectangle) ---
