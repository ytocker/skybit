"""Round-1 render for tl9 pins2: binder_clip"""
import os
...
def _attachment(card, affordable):
    ...
    hdl = (120, 124, 134) if affordable else (88, 92, 102)
    hi  = (180, 184, 192) if affordable else (150, 154, 162)
    kl  = (24, 26, 34)
    pygame.draw.rect(card, jaw, (10, 12, 14, 4))
    pygame.draw.polygon(card, hdl, [(10, 12), (12, 12), (13, 5)])
    pygame.draw.polygon(card, hdl, [(22, 12), (24, 12), (21, 5)])
    pygame.draw.line(card, hi, (10, 12), (13, 5), 1)
    pygame.draw.line(card, hi, (24, 12), (21, 5), 1)
    pygame.draw.line(card, kl, (12, 12), (13, 5), 1)
    pygame.draw.line(card, kl, (22, 12), (21, 5), 1)
