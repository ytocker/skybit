"""Round-1 render for tl9 pins2: zip_tie"""
import os
...
def _attachment(card, affordable):
    head = (34, 36, 42)
    stripe = (66, 68, 76) if affordable else (56, 58, 68)
    strap = (74, 76, 84) if affordable else (62, 64, 74)
    strap_hi = (150, 152, 160) if affordable else (130, 132, 142)
    slot = (60, 50, 40) if affordable else (44, 46, 56)
    pygame.draw.rect(card, head, (12, 8, 10, 5))
    pygame.draw.line(card, stripe, (12, 8), (22, 8), 1)
    pygame.draw.line(card, strap, (17, 13), (17, 20), 2)
    pygame.draw.line(card, strap, (17, 20), (22, 20), 2)
    pygame.draw.line(card, strap, (22, 20), (22, 13), 2)
    pygame.draw.rect(card, slot, (18, 17, 4, 2))
    pygame.draw.line(card, strap_hi, (17, 13), (17, 20), 1)
    pygame.draw.line(card, strap_hi, (22, 20), (22, 13), 1)
...
fh = hud_font(18)
fl = hud_font(12)
title = fh.render(f"tl9 pins2: {SLUG} — round 1", True, (240, 224, 180))
...
out = f"docs/store_price_tl9_pins2/{SLUG}/round_1.png"
