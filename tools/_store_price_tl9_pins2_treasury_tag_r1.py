"""Round-1 render for tl9 pins2: treasury_tag"""
import os
...
def _attachment(card, affordable):
    ...
    bar_fill = (206, 180, 120) if affordable else (150, 154, 166)
    string = (120, 90, 44) if affordable else (104, 108, 120)
    pygame.draw.line(card, string, (18, 12), (18, 20), 2)
    pygame.draw.rect(card, bar_outline, (13, 8, 10, 4))
    pygame.draw.rect(card, bar_fill, (14, 9, 8, 2))
    pygame.draw.rect(card, bar_outline, (13, 20, 10, 4))
    pygame.draw.rect(card, bar_fill, (14, 21, 8, 2))
