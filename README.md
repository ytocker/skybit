...
## Coin Redesign Candidates

The current in-game coin is a metallic gold disc with an embossed star — clean but a bit generic. Below are **five visually distinct alternatives** inspired by iconic coin/pickup designs from other games. Reply with a letter (**A**, **B**, **C**, **D**, or **E**) to pick which one to wire into the game.

<p align="center">
  <img src="docs/screenshots/coin_options.png" width="100%" alt="Five coin redesign candidates">
</p>

| Option | Name              | Vibe                                                                                     |
|--------|-------------------|------------------------------------------------------------------------------------------|
| **A**  | Classic Gold Disc | *Super Mario Bros.* flat-shaded solid disc with a bead rim and an embossed star face     |
| **B**  | Sonic Ring        | Hollow chrome-yellow torus with a fully transparent center — spins on the vertical axis  |
| **C**  | Faceted Gem       | *Zelda*-style emerald rupee with hard polygonal facets, refraction highlight, hex cut    |
| **D**  | Plasma Orb        | Modern-mobile soft glowing sphere, no hard rim, pink/magenta radial halo + sparkle cross |
| **E**  | Parrot Medallion  | Antique bronze medallion with scalloped edges, laurel wreath, and an embossed parrot     |

Preview regenerated by `python tools/coin_preview.py` → `docs/screenshots/coin_options.png`.
